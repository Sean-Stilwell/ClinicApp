...
public class CreateAccount extends AppCompatActivity {
    ...
    public void signUpClick(View view) {
        ...
        String firstName = this.retrieveFirstName();
        String lastName = this.retrieveLastName();
        String email = this.retrieveUserEmail();
        String password = this.retrieveUserPass();
        AccountType type = this.retrieveType();
        ...
        if(this.validUserInput(firstName,lastName,email,password)){
            ...
            if(type.equals(AccountType.EMPLOYEE)){
                ...
                this.signUpEmployee(email,password,employee);
            } else {
                Patient patient = new Patient(firstName,lastName,email);
                this.signUpPatient(email,password,patient);
            }
        } else {
    ...
    private void signUpPatient (String email, String pass,final Patient patient){
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                createAssociatedPatientAccount(user.getUid(), patient);

                            } else {
                                displayToast("Email could be used.");
                            }
                        }
                    });
        }

    private void signUpEmployee (String email, String pass,final Employee employee){
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            FirebaseUser user = Objects.requireNonNull(task.getResult()).getUser();
                            createAssociatedEmployeeAccount(user.getUid(), employee);
    ...
    private void createAssociatedPatientAccount (String userUID, Patient patient){
    ...
    private void createAssociatedEmployeeAccount (String userUID, Employee employee){
